...
maxPlayers = 1000
motd = "Welcome to the Zik Server!"
displayOnOrOffAtCharlist = false
onePlayerOnlinePerAccount = true
allowClones = false
serverName = "Baiak Zik VIP 9"
loginMessage = "Welcome to the baiak zik vip9!"
...
statusPort = 7171
ownerName = "[ADM] Energy"
ownerEmail = "energy@otserv"
url = "http://baiakzik-vip9.net/"
location = "Brazil"
